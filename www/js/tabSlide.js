    ...
    return {
        ...
        link: function(scope, element, attrs, parent) {
            ...
            var slideToCurrentPosition = function() {
                ...
                var targetWidth = targetTab[0].offsetWidth - 5;
                
                if(targetSlideIndex === 0)
                	indicator.addClass("home-indicator");
                else
                	indicator.removeClass("home-indicator");

                if(targetSlideIndex === 1)
                	indicator.addClass("trending-indicator");
                else
                	indicator.removeClass("trending-indicator");

                if(targetSlideIndex === 2)
                	indicator.addClass("trailers-indicator");
                else
                	indicator.removeClass("trailers-indicator");

                if(targetSlideIndex === 3)
                	indicator.addClass("search-indicator");
                else
                	indicator.removeClass("search-indicator");

                if(targetSlideIndex === 4)
                	indicator.addClass("profile-indicator");
                else
                	indicator.removeClass("profile-indicator");
